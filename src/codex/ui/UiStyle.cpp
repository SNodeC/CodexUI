...
QString applicationStyleSheet() {
  ...
  return QStringLiteral(R"QSS(
        * {
        ...
        QFrame[messageRole="agent"][messagePhase="update"] { background: #fff3bf; border: 1px solid #d9b83f; border-radius: 8px; }
        QFrame[messageRole="agent"][messagePhase="update"] QLabel[kind="title"],
        QFrame[messageRole="agent"][messagePhase="update"] QLabel[kind="messagePhase"] { color: #6f5300; }
