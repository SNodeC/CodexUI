...
inline constexpr auto yellow = "#b58900";
inline constexpr auto yellowHover = "#9b7500";
inline constexpr auto yellowPressed = "#805f00";
inline constexpr auto yellowSurface = "#fff9db";
inline constexpr auto yellowSurfaceHover = "#fff3b0";
inline constexpr auto yellowBorder = "#e4ca62";
inline constexpr auto yellowBorderStrong = "#cfb33f";
