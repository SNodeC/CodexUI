...
inline constexpr auto yellow = "#a97800";
inline constexpr auto yellowHover = "#8d6400";
inline constexpr auto yellowPressed = "#715000";
inline constexpr auto yellowSurface = "#fff6cf";
inline constexpr auto yellowSurfaceHover = "#ffedaa";
inline constexpr auto yellowBorder = "#dfc45a";
inline constexpr auto yellowBorderStrong = "#c5a437";
inline constexpr auto yellowText = "#765c00";
