...
inline constexpr auto yellowSurface = "#fff3bf";
inline constexpr auto yellowSurfaceHover = "#ffe99a";
inline constexpr auto yellowBorder = "#d9b83f";
inline constexpr auto yellowBorderStrong = "#bd9820";
inline constexpr auto yellowText = "#6f5300";
