...
void paintMark(QPainter &painter, const QRectF &bounds) {
  ...
  painter.setPen(QPen(QColor(QString::fromLatin1(UiStyle::brandAccent)), 3.2,
...
private:
  void updateTitleFont() {
    ...
    const QString style = QStringLiteral("font-size:%1px;").arg(titlePixelSize);
    if (title->styleSheet() != style)
