...
#ifndef CODEXUI_APP_FRONTENDSESSIONWORKER_H
#define CODEXUI_APP_FRONTENDSESSIONWORKER_H
...
unixPeerCredentialError(qintptr socketDescriptor,
                        uid_t expectedUserId) noexcept;
...
class FrontendSessionWorker : public QObject
{
    Q_OBJECT

public:
    using Lifecycle = FrontendSession::Lifecycle;
    using ArchivedThreadDiscoveryStatus = FrontendSession::ArchivedThreadDiscoveryStatus;
    using OperationCompletion = FrontendSession::OperationCompletion;
    using ThreadStartCompletion = FrontendSession::ThreadStartCompletion;
    using TurnStartCompletion = FrontendSession::TurnStartCompletion;

    explicit FrontendSessionWorker(QObject* parent = nullptr);
    ~FrontendSessionWorker() override;
...
private:
    friend struct FrontendSessionWorkerTestAccess;
...
#endif // CODEXUI_APP_FRONTENDSESSIONWORKER_H
