...
int main(int argc, char *argv[]) {
  ...
  auto *configuration =
      utils::Config::configRoot.newSubCommand<codexui::codex2::Configuration>();
  QApplication application(argc, argv);
  core::SNodeC::init(argc, argv);

  codexui::codex2::FrontendSession session(*configuration);
  codexui::codex2::MainWindow window(session);
