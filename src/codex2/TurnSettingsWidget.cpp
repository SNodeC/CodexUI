...
TurnSettingsWidget::TurnSettingsWidget(QWidget *parent) : QWidget(parent) {
  setObjectName(QStringLiteral("codex2TurnSettings"));
  setStyleSheet(QStringLiteral(
      "QWidget#codex2TurnSettings{background:#ffffff;border-top:1px solid "
  ...
  model = compactCombo("codex2Model");
  model->setEditable(true);
  effort = compactCombo("codex2Effort");
  sandbox = compactCombo("codex2Sandbox");
  network = compactCombo("codex2Network");
  cwd = new QLineEdit;
  cwd->setObjectName(QStringLiteral("codex2Workspace"));
  cwd->setFixedHeight(32);
  cwd->setPlaceholderText(QStringLiteral("Codex default workspace"));
  approval = compactCombo("codex2Approval");
  personality = compactCombo("codex2Personality");
  ...
  permissionProfile = compactCombo("codex2PermissionProfile");
  reviewer = compactCombo("codex2Reviewer");
  serviceTier = compactCombo("codex2ServiceTier");
  serviceTier->setEditable(true);
  summary = compactCombo("codex2Summary");
  collaboration = compactCombo("codex2Collaboration");
