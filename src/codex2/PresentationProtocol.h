...
#ifndef CODEXUI_CODEX2_PRESENTATIONPROTOCOL_H
#define CODEXUI_CODEX2_PRESENTATIONPROTOCOL_H
...
namespace codexui::codex2::presentation {
...
#endif // CODEXUI_CODEX2_PRESENTATIONPROTOCOL_H
