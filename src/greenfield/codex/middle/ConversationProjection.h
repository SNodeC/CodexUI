...
#ifndef CODEXUI_GREENFIELD_CODEX_MIDDLE_CONVERSATIONPROJECTION_H
#define CODEXUI_GREENFIELD_CODEX_MIDDLE_CONVERSATIONPROJECTION_H
...
#endif // CODEXUI_GREENFIELD_CODEX_MIDDLE_CONVERSATIONPROJECTION_H
