...
int main() {
  using codexui::codex2::PresentationModel;
  using codexui::codex2::ProtocolNormalizer;
  ...
  for (const nlohmann::json &frame : frames) {
    validFrames &= codexui::codex2::presentation::isPresentationFrame(frame);
